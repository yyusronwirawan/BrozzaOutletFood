        ...
        <div class="tb-gudang  ">
            <div style="border-style: dashed; border-color:#537fe7; padding:4px 20px 230px;overflow:auto; max-height: 700px;">
                <div class="col border rounded p-2 mt-2">
                    ...
                    <form class="d-flex" action="{{ route('jadwalPengiriman.search.pegawai') }}" method="GET">
                                            ...
                                            <td>
                                                ...
                                                <div class="modal fade" id="exampleModalEdit{{ $jp->id }}" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <form action="{{ route('jadwalPengiriman.update.pegawai') }}"
                                                                method="POST">
                                                                {{ csrf_field() }}
                                                ...
                                                <button type="button" class="btn btn-outline-danger">
                                                    <a class="text-decoration-none text-black"
                                                        href="{{ route('jadwalPengiriman.delete.pegawai', ['id' => $jp->id]) }}">
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('jadwalPengiriman.create.pegawai') }}" method="POST">
                    {{ csrf_field() }}
                    <div class="modal-body">
                        <div class="mb-3">
