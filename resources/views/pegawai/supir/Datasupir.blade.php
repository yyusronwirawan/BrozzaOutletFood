        ...
        <div class="tb-gudang  ">
            <div style="border-style: dashed; border-color:#537fe7; padding:4px 20px 230px;overflow:auto; max-height: 700px;">
                <div class="col border rounded p-2  mt-2">
                    ...
                    <p>Cari Data Supir:</p>
                    <form class="d-flex" action="{{ route('supir.search.pegawai') }}" method="GET">
                        <input class=" form-control" type="text" name="search" placeholder="Cari Supir .."
                            value="{{ old('search') }}">
                                        ...
                                        <td>
                                            ...
                                            <div class="modal fade" id="exampleModalEdit{{ $data->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="{{ route('supir.update.pegawai') }}" method="POST">
                                                            @csrf
                                            ...
                                            <button type="button" class="btn btn-outline-danger">
                                                <a class="text-decoration-none text-black"
                                                    href="{{ route('supir.delete.pegawai', ['id_pengguna' => $data->id_pengguna]) }}">
                    ...
                    {{ $supir->links('pagination::bootstrap-5') }}
                </div>   
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('supir.create.pegawai') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="id_pengguna" class="form-label">Konfirmasi Supir</label>
