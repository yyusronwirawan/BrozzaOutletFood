        ...
        <div class="tb-Truk  ">
            <div style="border-style: dashed; border-color:#537fe7; padding:4px 20px 230px;overflow:auto; max-height: 700px;">
                <div class="col border rounded p-2 mt-2">
                    ...
                    <p>Cari Data Truk:</p>
                    <form class="d-flex" action="{{ route('truk.search.supir') }}" method="GET">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ route('truk.create.supir') }}" method="POST">
                                        {{ csrf_field() }}
                                        <div class="mb-3">
                                ...
                                @foreach ($truk as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="modal fade" id="exampleModalEdit{{ $item->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{ route('truk.update.supir') }}" method="POST">
                                                                {{ csrf_field() }}
                                                                {{-- hidden --}}
                                            ...
                                            <!-- Modal edit end -->
                                            <button type="button" class="btn btn-outline-danger">
                                                <a class="text-decoration-none text-black"  href="{{ route('truk.delete.supir', ['id' => $item->id]) }}">
