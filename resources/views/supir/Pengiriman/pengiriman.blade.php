    ...
    <div class="container">
        <div class="tb-gudang  ">
            <div class="col border rounded p-2 ">
                ...
                <form class="d-flex" action="{{ route('pengiriman.search.supir') }}" method="GET">
                                    ...
                                    <td>
                                        ...
                                        <div class="modal fade" id="exampleModalEdit{{ $loop->index }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('pengiriman.update.supir') }}" method="POST">
                                                        @csrf
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="id_jadwal_pengiriman" class="form-label">Jadwal
                                                                    Pengiriman</label>
                                                                <select class="jadwal form-control"
                                        ...
                                        <button type="button" class="btn btn-outline-danger">
                                            <a class="text-decoration-none text-black"
                                                href="{{ route('pengiriman.delete.supir', ['kode_pesanan' => $item->pemesanan->kode_pesanan]) }}">
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('pengiriman.create.supir') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="mb-3">
