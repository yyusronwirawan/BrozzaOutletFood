    ...
    <div class="container">
        <div class="tb-gudang  ">
            <div class="col border rounded p-2 ">
                ...
                <form class="d-flex" action="{{ route('rute.search.supir') }}" method="GET">
                            ...
                            @foreach ($rute as $group)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <!-- Modal Edit Status -->
                                        <div class="modal fade" id="editModal{{ $item->pengiriman->pemesanan->kode_pesanan }}" tabindex="-1"
                                            aria-labelledby="editModalLabel{{ $item->pengiriman->pemesanan->kode_pesanan }}" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="editModalLabel{{ $item->pengiriman->pemesanan->kode_pesanan }}">Edit
                                                    ...
                                                    <div class="modal-body">
                                                        <!-- Form edit status -->
                                                        <form action="{{ route('rute.update.supir' )}}"
                                                            method="POST">
                                                            @csrf
                                                            <!-- Isi form dengan data status yang ingin diubah -->
                                                            <input type="hidden" name="kode_pesanan" value="{{$item->pengiriman->pemesanan->kode_pesanan}}">
                                                            <div class="mb-3">
                                        ...
                                        <button type="button" class="btn btn-outline-danger">
                                            <a class="text-decoration-none text-black" href="{{route('rute.delete.supir',['kode_pesanan'=>$item->pengiriman->pemesanan->kode_pesanan])}}">
