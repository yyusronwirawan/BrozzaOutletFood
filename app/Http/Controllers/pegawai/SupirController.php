...
class SupirController extends Controller
{
    ...
    function index()
    {
        ...
        return view('pegawai.supir.Datasupir', $data);
    }
    ...
    public function tambahIdPengguna(Request $request)
    {
        ...
        if ($existingSupir) {
            return redirect('/pegawai/supir')->with('error', 'Id pengguna telah ada di tabel supir.');
        }
        ...
        return redirect('/pegawai/supir')->with('success', 'Id pengguna berhasil ditambahkan ke tabel supir.');
    }
    ...
    public function hapusIdPengguna(Request $request)
    {
        ...
        return redirect('/pegawai/supir')->with('delete', 'Id pengguna berhasil dihapus dari tabel supir.');
    }
    // search data supir
    ...
    function update(Request $request)
    {
        ...
        return redirect('/pegawai/supir')->with('edit', 'Data User Berhasil Diubah');
    }
}
