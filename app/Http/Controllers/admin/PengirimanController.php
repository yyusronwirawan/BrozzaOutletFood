...
class PengirimanController extends Controller
{
    function index()
    {
        ...
        return view('admin.Pengiriman.pengiriman', $data);
    }
    ...
    function update(Request $request)
    {
        ...
        return redirect('/admin/pengiriman')->with('edit', 'Status Pengiriman Berhasil Diubah');
    }
    public function delete(Request $request)
    {
        ...
        return redirect('/admin/pengiriman')->with('delete', 'Data Berhasil Dihapus');
    }
