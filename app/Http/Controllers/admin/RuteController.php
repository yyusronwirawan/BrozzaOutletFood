...
class RuteController extends Controller
{
    public function index()
    {
        ...
        return view('admin.Rute.rute', $data);
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect('/admin/rute')->with('edit', 'Status rute berhasil diperbarui.');
    }
    ...
    //     return redirect('/admin/rute')->with('delete', 'Rute dan pengiriman berhasil dihapus.');
    // }
}
