...
class sirkulasiBarangController extends Controller
{
    ...
    public function indexBrgMasuk()
    {
        ...
        return view(
            'admin.sirkulasiBarang.barangMasuk',
            $data
        );
    }
    ...
    function createBrgMasuk(Request $request)
    {
        ...
        $barang->save();
        return redirect('/admin/barangMasuk')->with('success', 'Data Barang Masuk Berhasil Ditambahkan');
    }
    ...
    function updateBrgMasuk(Request $request)
    {
        ...
        return redirect('/admin/barangMasuk')->with('edit', 'Data Barang Masuk Berhasil Diupdate');
    }
    ...
    //     // $sirkulasiBarang->delete();
    //     return redirect('/admin/barangMasuk')->with('delete', 'Data Barang Masuk Berhasil Dihapus');
    // }
    ...
    public function indexBrgKeluar()
    {
        ...
        //     ];
        //     return view(
        //         'admin.sirkulasiBarang.barangKeluar',
        //         $data
        //     );
    ...
    //     $barang->stok_akhir -= $request->jumlah;
    //     $barang->save();
    //     return redirect('/admin/barangKeluar')->with('success', 'Data Barang Keluar Berhasil Ditambahkan');
    // }
    ...
    //     return redirect('/admin/barangKeluar')->with('edit', 'Data Barang Masuk Berhasil Diupdate');
    // }
    ...
    //      $sirkulasiBarang->delete();
    //      // $sirkulasiBarang->delete();
    //      return redirect('/admin/barangKeluar')->with('delete', 'Data Barang Masuk Berhasil Dihapus');
    //  }
