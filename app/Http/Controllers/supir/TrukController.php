...
class TrukController extends Controller
{
    ...
    function index()
    {
        ...
        return view('supir.Truck.truk', ['truk' => $truk]);
    }
    // menambah data truk
    function create(Request $request)
    {
        ...
        return redirect('/supir/truk')->with('success', 'Data Berhasil Ditambahkan');
    }
    // Update data truk
    function update(Request $request)
    {
        ...
        return redirect("/supir/truk")->with('edit', 'Data Berhasil Diubah');
    }
    // hapus data truk
    function delete(Request $id)
    {
        truk::find($id->id)->delete();
        return redirect("/supir/truk")->with('delete', 'Data Berhasil Dihapus');
    }
    // search data truk
