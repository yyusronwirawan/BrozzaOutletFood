...
class RuteController extends Controller
{
    public function index()
    {
        ...
        return view('supir.Rute.rute', $data);
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect('/supir/rute')->with('edit', 'Status rute berhasil diperbarui.');
    }
    public function delete(Request $request)
    {
        ...
        return redirect('/supir/rute')->with('delete', 'Rute dan pengiriman berhasil dihapus.');
    }
}
